    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-content" style={{ marginTop: '2rem', maxWidth: '800px', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        <form onSubmit={handleGlobalSubmit} style={{ background: '#fff', padding: '2rem', borderRadius: '12px', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          ...
          <h3 style={{ marginBottom: '1.5rem', color: 'var(--text-primary)', backgroundColor: '#dcfce7', border: '1px solid #bbf7d0', borderRadius: '8px', padding: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            Logo Configuration
            {!isEditingGlobal && (
              <button type="button" onClick={() => setIsEditingGlobal(true)} style={{ background: '#fff', border: '1px solid #bbf7d0', padding: '0.4rem 1rem', borderRadius: '6px', cursor: 'pointer', fontSize: '0.9rem', color: '#166534', fontWeight: '600', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)' }}>
                Edit Settings
              </button>
            )}
          </h3>
        ...
        <form onSubmit={handleProfileSubmit} style={{ background: '#fff', padding: '2rem', borderRadius: '12px', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <h3 style={{ marginBottom: '1.5rem', color: 'var(--text-primary)', backgroundColor: '#dbeafe', border: '1px solid #bfdbfe', borderRadius: '8px', padding: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            Admin Profile Credentials
            {!isEditingProfile && (
              <button type="button" onClick={() => setIsEditingProfile(true)} style={{ background: '#fff', border: '1px solid #bfdbfe', padding: '0.4rem 1rem', borderRadius: '6px', cursor: 'pointer', fontSize: '0.9rem', color: '#1e40af', fontWeight: '600', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)' }}>
                Edit Profile
              </button>
            )}
          </h3>
