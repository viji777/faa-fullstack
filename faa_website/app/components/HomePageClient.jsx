        ...
        <div className={styles.contactContainer}>
          ...
          >
            ...
            <div className={styles.contactCardsWrapper}>
              <a href={`https://wa.me/${settings.phone}`} target="_blank" rel="noopener noreferrer" className={styles.contactCard}>
              ...
              <a href={`tel:+${settings.phone}`} className={styles.contactCard}>
                <div className={styles.contactCardIconWrap}>
                  <Phone size={24} />
                </div>
                <div className={styles.contactCardTextWrap}>
                  <span className={styles.contactCardTitle}>+{settings.phone}</span>
              ...
              <a href={`mailto:${settings.email}`} className={styles.contactCard}>
                ...
                <div className={styles.contactCardTextWrap}>
                  <span className={styles.contactCardTitle}>{settings.email}</span>
