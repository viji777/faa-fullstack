...
import { ChevronLeft, ChevronRight, Menu, X, Search, User, ShoppingCart, Info, Lock, Truck, ShieldCheck, HeartPulse, Brain, Zap, Leaf, LeafyGreen, Award, Sprout, Users, Mail, Phone, MapPin, MessageSquare, Send } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        setBanners(bannersRes.slice(0, 5));
